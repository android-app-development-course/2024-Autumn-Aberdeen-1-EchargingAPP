...
import com.zzh.echarging.databinding.ActivityLoginZzhBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            register.setOnClickListener{
                startActivity(Intent(this@LoginActivity, zzh_RegisterActivity::class.java))
            }
                    ...
                    getDao().getUserByChepaiHao(count1).let {
                        if (it != null) {
                            launch(Dispatchers.Main) {
                                user = it
                                startActivity(Intent(this@LoginActivity, zzh_MainActivity::class.java))
                                toast("登录成功")
                            }
                            return@launch
                        } else {
